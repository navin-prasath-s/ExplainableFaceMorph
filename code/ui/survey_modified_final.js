document.addEventListener('DOMContentLoaded', function() {
    ...
    const numImagesInDatabase = 10;
    const exp2_no_of_images = 5;
    const exp2_range_of_images = 17;
    ...
    const phase2InstructionPage = document.getElementById('phase2InstructionPage');
    const startPhase2Btn = document.getElementById('startPhase2Btn');

    // Initialize page visibility
    landingPage.style.display = 'block';
    taskPage.style.display = 'none';
    canvasApp.style.display = 'none';
    phase2InstructionPage.style.display = 'none';
    ...
    startPhase2Btn.addEventListener('click', function() {
        phase2InstructionPage.style.display = 'none';
        canvasApp.style.display = 'block';
        controls.style.display = 'block';
    ...
    function submitMask() {
        ...
        .then(data => {
            ...
            if (currentImageIndex < numImagesToSample) {
                ...
                // Show Phase 2 instruction page
                canvasApp.style.display = 'none';
                phase2InstructionPage.style.display = 'block';
            }
        })
        .catch(error => {
